...
from module.gilded_rose import Item, GildedRose, Altbier, AgedBrie, BackstageTicket, Sulfuras, DefaultItem
...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_aged_backstage_passes_to_a_TAFKAL80ETC_concert(self):
        items = [BackstageTicket("Backstage passes to a TAFKAL80ETC concert", 0, 0)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_increase_quality_by_2_if_name_eq_Backstage_and_sell_in_lt_11_and_quality_lt_50(
            self):
        # Arrange
        items = [BackstageTicket(name="Backstage passes to a TAFKAL80ETC concert", sell_in=10, quality=0)]
        gilded_rose = GildedRose(items)
    ...
    def test_increase_quality_by_3_if_name_eq_Backstage_and_sell_in_lt_6_and_quality_lt_50(
            self):
        # Arrange
        items = [BackstageTicket(name="Backstage passes to a TAFKAL80ETC concert", sell_in=5, quality=0)]
        gilded_rose = GildedRose(items)
    ...
    def test_same_quality_if_name_eq_Backstage_and_quality_gt_49(
            self):
        # Arrange
        items = [BackstageTicket(name="Backstage passes to a TAFKAL80ETC concert", sell_in=5, quality=50)]
        gilded_rose = GildedRose(items)
    ...
    def test_decrease_quality_by_2_if_unknown_name_and_sell_in_lt_0_and_quality_gt_1(self):
        # Arrange
        items = [DefaultItem(name="my_name", sell_in=-1, quality=2)]
        gilded_rose = GildedRose(items)
    ...
    def test_dont_decrease_quality_if_name_sulfuras_and_sell_in_lt_0_and_quality_gt_1(self):
        # Arrange
        items = [Sulfuras(name="Sulfuras, Hand of Ragnaros", sell_in=-1, quality=2)]
        gilded_rose = GildedRose(items)
    ...
    def test_sulfuras_hand_of_ragnaros(self):
        items = [Sulfuras("Sulfuras, Hand of Ragnaros", 0, 0)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_quality_never_above_50(self):
        ...
        items = [AgedBrie("Aged Brie", 5, 50)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(50, items[0].quality)

    def test_sulfuras_never_decreases_quality(self):
        items = [Sulfuras("Sulfuras, Hand of Ragnaros", 5, 39)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_backstage_passes_qual_increases(self):
        items = [BackstageTicket("Backstage passes to a TAFKAL80ETC concert", 5, 39)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertGreater(items[0].quality, 39)

    def test_backstage_quality_increases_by_two_at_10_days_or_less(self):
        items = [BackstageTicket("Backstage passes to a TAFKAL80ETC concert", 10, 4)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(6, items[0].quality)

    def test_backstage_quality_increases_by_three_at_5_days_or_less(self):
        items = [BackstageTicket("Backstage passes to a TAFKAL80ETC concert", 5, 4)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(7, items[0].quality)

    def test_backstage_quality_is_zero_after_concert(self):
        items = [BackstageTicket("Backstage passes to a TAFKAL80ETC concert", 0, 4)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(0, items[0].quality)
    ...
    def test_summoned_blub_degrades_thrice_as_fast(self):
        items = [DefaultItem("summoned blub", sell_in=20, quality=15)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
